      ...
      <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start lg:gap-14">
        ...
        <ul className="grid gap-3">
          {benefits.map((benefit) => (
            <li
              key={benefit}
              className="flex gap-4 rounded-2xl border border-stone-200/80 bg-white/75 p-5 text-stone-800 shadow-[0_12px_32px_rgba(68,64,60,0.06)] transition-all duration-300 hover:translate-x-1 hover:-translate-y-0.5 hover:border-stone-300 hover:bg-white hover:shadow-[0_18px_40px_rgba(68,64,60,0.11)] active:translate-x-0.5"
            >
              <span
                aria-hidden="true"
